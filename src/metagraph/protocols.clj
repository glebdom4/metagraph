...
(defprotocol Component
  ...
  (remove-from-fragment [this fragment] "Removes the component from a fragment")
  (t-remove-from-fragment [this fragment] "Transitively removes the component from a fragment"))
